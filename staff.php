...
<div class="wrapper">
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2019 <a onclick="return confirm('Please contact the Administrator.') href="#">Students Missing Marks Complain System</a>.</strong> All rights reserved.
  </footer>
