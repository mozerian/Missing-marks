  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <form action="lecturer.php" method="post">
            ...
            <button  style="padding: 6px;border-radius: 10px; width:100px; margin-left:20px; font-size: 19px; font-family:Times New Romans; font-weight: 5px; margin-bottom: 10px;"><a href="lecturerreport.php">Report</a></button>
            <table>
                <tr> 
                    <th>Reg No.</th>
                    <th>Course Code</th>
