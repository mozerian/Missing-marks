...
if (empty($_POST)===false)
{
  ...
  $staff = $_POST['username'];
  $password= $_POST['password'];

  if(lecturer_exists($staff, $con))
  {
     $result = mysqli_query ($con, "SELECT password FROM lecturer WHERE lpf_No='$staff'");
   ...
   if(cod_exists($staff, $con))
  {
     $result = mysqli_query ($con, "SELECT password FROM cod WHERE cpf_No='$staff'");
     $retrievepassword = mysqli_fetch_assoc($result);
  ...
  if(dean_exists($staff, $con))
  {
     $result = mysqli_query ($con, "SELECT password FROM dean WHERE dpf_No='$staff'");
     $retrievepassword = mysqli_fetch_assoc($result);
   ...
   if(regist_exists($staff, $con))
  {
     $result = mysqli_query ($con, "SELECT password FROM registrar WHERE rpf_No='$staff'");
     $retrievepassword = mysqli_fetch_assoc($result);
    ...
    <section class="content container-fluid">
        ...
        <div id="wrapperformLogin2">
          <?php echo $error; ?>
            ...
            <form method="POST" action="staffLogin.php" enctype="multipart/form-data">
              <div class="row">
                <div class="col-25">
              <label id="labels">Username:</label><br>
              </div>
              <div class="col-75">
              <input id="inputs" type="text" name="username" placeholder="enter username" required=""><br><br>
               </div>
                </div>
                 <div class="row">
                  <div class="col-25">
